function [optV_all, rmseV_all, optmdl_all, rmsemdl_all] = joca_1w1ysephySPXonly(year, halfyear, data_path, save_path, model, method, retol)
% parameter esitmation using two-step iterative algorithm based on SPX
% options for each half year ('halfyear' represents the first/second half of the year)
filename = [num2str(year), '_half', num2str(halfyear), '_', model, '.mat'];
