function [optV_all, rmseV_all, optmdl_all, rmsemdl_all] = joca_1w1ysep(year, data_path, save_path, model, method, retol)
% parameter esitmation using two-step iterative algorithm
